    ...
    <div className={" bg-gray"}>
      <footer className="footer">
        <div className={"logo flex justify-center"}>
          <a href="/">
            <img className={"w-36"} src={logo_footer} alt="Atrium Studio Logo" width={"100%"}/>
          </a>
        </div>
        <div className="social flex justify-center items-center">
          <p className={"flex gap-2"}>
            <a href="tel:+15038804665" target="_blank" rel="noopener noreferrer" className={"hover:fill-gray"}>
            ...
            <a href="mailto:info@atriumstaging.com" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://www.instagram.com/atriumstaging/" target="_blank" rel="noopener noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="white"
                   viewBox="0 0 448 512">
                <path
            ...
            <a href="https://www.facebook.com/atriumstaging/" target="_blank" rel="noopener noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="white" className="bi bi-facebook"
                   viewBox="0 0 16 16">
                <path
                  d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"></path>
              </svg>
            </a>
            <a href="https://www.pinterest.com/atriumstaging" target="_blank" rel="noopener noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="white"
                   viewBox="0 0 448 512">
                <path
